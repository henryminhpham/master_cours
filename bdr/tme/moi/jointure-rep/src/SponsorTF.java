...
public class SponsorTF {
    ...
    public void traiteRequete() {
        try {
			...
			String requete2 = "select S.Nom, S.Nationalite from Sponsor S order by S.Nom";
			...
			while (resultat.next()) {
				...
				String nom_sponsor2 = resultat2.getString(1);

				while (!nom_sponsor.equals(nom_sponsor2)) {
					//System.out.println("entrer ");
					resultat2.next();
					nom_sponsor2 = resultat2.getString(1);

				}
				result = nom_j + ", " + nationalite + ", " + nom_sponsor + ", " + resultat2.getString(2);
				
				//out.println(result + cpt);
			}
