 ...
 * La classe Sponsor
 **/
public class SponsorPreparedStatement {
    ...
    public static void main(String a[]) {
        ...
        /* initialisation */
        SponsorPreparedStatement c = new SponsorPreparedStatement();
     ...
     **/
    private SponsorPreparedStatement(){
        try {
    ...
    public void traiteRequete() {
        try {
			...
			String requete2 = "select S.Nationalite from Sponsor S where S.Nom = ?";
			...
			PreparedStatement lecture2 = connexionSponsor.prepareStatement(requete2);
			...
			while (resultat.next()) {
				...
				lecture2.setString(1, nom_sponsor);
				
				resultat2 = lecture2.executeQuery();
				resultat2.next();
